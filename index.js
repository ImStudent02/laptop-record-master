...
const username = encodeURIComponent("yc");
const password = encodeURIComponent("UAhQWGmW4ep13pVI");

let dbUrl = `mongodb+srv://${username}:${password}@laptop.ipbvhjb.mongodb.net/?retryWrites=true&w=majority&appName=Laptop`
